        ...
        >
          ...
          <View className="flex-row items-center mb-8 gap-6">
            <View className="items-center">
              <Text className="text-[22px] font-bold text-[#0F172A] mb-1">Log In</Text>
              <View className="h-1 w-6 bg-[#1A6B5A] rounded-full" />
            </View>
            <TouchableOpacity onPress={() => router.replace('/(auth)/register')}>
              <Text className="text-[22px] font-bold text-[#64748B]">Sign up</Text>
            </TouchableOpacity>
          </View>
          ...
          {/* Forgot */}
          <TouchableOpacity className="mt-4 mb-6 items-end">
            <Text className="text-[#1A6B5A] text-sm font-semibold">Forgot Password?</Text>
          </TouchableOpacity>

          {/* Sign in */}
          <TouchableOpacity className="bg-[#1A6B5A] py-4 rounded-2xl items-center" onPress={() => setModalVisible(true)}>
